Feature: Test longevity and stress the systems
  ...
  Scenario: Test transaction time
    ...
    Then The average transaction time is less than 0.1 second
  ...
  @serial
  Scenario: Test transaction time
    When I make a 10 transactions with http method
    Then The average transaction time is less than 0.5 second
    And I await confirm the transaction
    And All transactions work
    And I kill all running epic systems
  ...
  @serial
  Scenario: Test transaction time
    When I make a 100 transactions with http method
    Then The average transaction time is less than 10.0 second
    And I await confirm the transaction
    And All transactions work
    And I kill all running epic systems
